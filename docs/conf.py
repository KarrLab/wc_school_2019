...
project = u'wc_school_2019'
copyright = u'2019, Karr Lab'
author = u'Karr Lab'
...
version = wc_school_2019.__version__
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/KarrLab/wc_school_2019/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/KarrLab/wc_school_2019/blob/master/{}/__init__.py".format(rel_filename)
...
#
# html_title = u'wc_school_2019 v0.0.1'
...
htmlhelp_basename = 'wc_school_2019-doc'
...
latex_documents = [
    (master_doc, 'wc_school_2019.tex', u'wc_school_2019 documentation',
     u'Karr Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'wc_school_2019', u'wc_school_2019 documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wc_school_2019', u'wc_school_2019 documentation',
     author, 'wc_school_2019', 'One line description of project.',
     'Miscellaneous'),
]
